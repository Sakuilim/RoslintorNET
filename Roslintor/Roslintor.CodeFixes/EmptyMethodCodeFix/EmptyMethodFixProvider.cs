...
namespace Roslintor.EmptyMethodCodeFix
{
    ...
    public class EmptyMethodFixProvider : CodeFixProvider
    {
        ...
        private async Task<Solution> MakeCamelCaseAsync(Document document, MethodDeclarationSyntax typeDecl, CancellationToken cancellationToken)
        {
            ...
            var newSolution = await Renamer.RenameSymbolAsync(document.Project.Solution, typeSymbol, newName, optionSet).ConfigureAwait(false);
